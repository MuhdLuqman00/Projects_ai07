...
SEED = 12345
(x_interim, x_val, y_interim, y_val) = train_test_split(data_features, data_labels, test_size = 0.2, random_state = SEED)
...
BATCH_SIZE = 32
EPOCHS = 100
history = model.fit(x_train, y_train, validation_data=(x_val,y_val), batch_size=BATCH_SIZE, epochs=EPOCHS, callbacks=[tb,es])
